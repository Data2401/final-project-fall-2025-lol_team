...
1. TMR_tbl create column (boolean) indicating win or lose. 
...
4. Plot game duration density 
5. TMR_tbl find the mean, median, max and min (all kills) only for classic queue types
6. TMR_tbl Count the number game plays per queue types plot
