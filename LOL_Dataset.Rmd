...
```{r, echo=FALSE, eval=TRUE,  fig.width=10, fig.height=12}
grid.arrange(mean5, med5, max5, nrow=3, top = textGrob("Player Gold Stats", gp = gpar(fontsize = 20, fontface = "bold")),left = textGrob("Lane", rot = 90, gp = gpar(fontsize = 16, fontface = "bold")), bottom = textGrob("Average",gp = gpar(fontsize = 16, fontface = "bold")))
