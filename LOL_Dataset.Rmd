...
1. TMR_tbl Filter teams with winning arams, classics based on rank. 
2. TMR_tbl create column (boolean) indicating win or lose. 
3. TMR_tbl Filter winning teams, most used champion in red team and blue team 
4. TMR_tbl create column (boolean) indicating win or lose. 
