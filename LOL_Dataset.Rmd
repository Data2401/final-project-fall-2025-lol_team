...
ggplot(Team_Winner_Tbl, aes(x = GameDuration, y = Kills, color = Side)) + geom_jitter( alpha= 0.5) +
  labs(title = "Game Duration vs Kills by Side", x = "Game Duration (Seconds)", y = "Kills") +
  scale_color_manual(values = c("Red" = "red", "Blue" = "blue"))
...
ggplotly(ggplot(Team_Winner_Tbl, aes(x = GameDuration, y = Kills, color = QueueType)) +
           ...
           labs(title = "Game Duration vs Kills by Queue Type", x = "Game Duration (Seconds)", y = "Kills"))
...
```{r, echo=FALSE}
ggplot(Team_Winner_Tbl, aes(x = GameDuration, color = Side)) + geom_density() + labs(title = "Distribution of Game Duration", x = "Game Duration (Seconds)", y = "Density") +  scale_color_manual(values = c("Red" = "red", "Blue" = "blue"))
...
grid.arrange(mean1, med1, max1, nrow=3, top = textGrob("Player Minion Stats", gp = gpar(fontsize = 20, fontface = "bold")),left = textGrob("Lane", rot = 90, gp = gpar(fontsize = 16, fontface = "bold")), bottom = textGrob("Average",gp = gpar(fontsize = 16, fontface = "bold")))

```


```{r, echo=FALSE, eval=TRUE,  fig.width=10, fig.height=12}
grid.arrange(mean2, med2, max2, nrow=3, top = textGrob("Player Tower(Turret) Stats", gp = gpar(fontsize = 20, fontface = "bold")),left = textGrob("Lane", rot = 90, gp = gpar(fontsize = 16, fontface = "bold")), bottom = textGrob("Average",gp = gpar(fontsize = 16, fontface = "bold")))

```


```{r, echo=FALSE, eval=TRUE,  fig.width=10, fig.height=12}
grid.arrange(mean3, med3, max3, nrow=3, top = textGrob("Player Damage Taken Stats", gp = gpar(fontsize = 20, fontface = "bold")),left = textGrob("Lane", rot = 90, gp = gpar(fontsize = 16, fontface = "bold")), bottom = textGrob("Average",gp = gpar(fontsize = 16, fontface = "bold")))

```


```{r, echo=FALSE, eval=TRUE,  fig.width=10, fig.height=12}
grid.arrange(mean4, med4, max4, nrow=3, top = textGrob("Player Damage Dealt Stats", gp = gpar(fontsize = 20, fontface = "bold")),left = textGrob("Lane", rot = 90, gp = gpar(fontsize = 16, fontface = "bold")), bottom = textGrob("Average",gp = gpar(fontsize = 16, fontface = "bold")))

```


```{r, echo=FALSE, eval=TRUE,  fig.width=10, fig.height=12}
grid.arrange(mean5, med5, max5, nrow=3, top = textGrob("Player Gold Stats", gp = gpar(fontsize = 20, fontface = "bold")),left = textGrob("Role", rot = 90, gp = gpar(fontsize = 16, fontface = "bold")), bottom = textGrob("Average",gp = gpar(fontsize = 16, fontface = "bold")))
...
**Champions and items used** in the data below we selected the top 10 most played champions and what are commonly purchased by a user and their rank
...
plot_each_rank_champ <- top_champs_by_rank %>% 
  group_by(RankName) %>% 
  group_map(~ {
  ggplot(.x,
...
plot_each_rank_champ[[1]]
plot_each_rank_champ[[2]]
plot_each_rank_champ[[3]]
plot_each_rank_champ[[4]]
plot_each_rank_champ[[5]]
plot_each_rank_champ[[6]]
plot_each_rank_champ[[7]]
plot_each_rank_champ[[8]]
plot_each_rank_champ[[9]]
plot_each_rank_champ[[10]]
plot_each_rank_champ[[11]]
```
