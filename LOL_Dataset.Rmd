...
What we did is join most of our data sets to have a more efficient data structure. The following data sets were created:
 ...
 - **SMR_Tbl**: This data set displays the players key detailed match stats.
...
Game duration plays a big part in Summoners Rift Map (CLASSIC). 
...
Max kills vary through map, as you can see not 
